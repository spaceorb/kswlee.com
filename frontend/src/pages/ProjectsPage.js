                  ...
                  <div className="flex flex-col items-center justify-evenly">
                    ...
                    <div className=" mt-2 px-10 project-1 max-w-[500px] top-[10px]">
                      <p className="text-center text-sm">
                        ...
                        Next.js, Redux, TypeScript, Material-UI, Node.js,
                        MongoDB, Express.js, GraphQL, Jest, Cypress, Docker,
                        CI/CD, Heroku, Photoshop
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-evenly">
                    ...
                    <div className=" mt-2 px-10 project-2 top-[10px] max-w-[500px]">
                      <p className="text-center text-sm">
                        ...
                        Socket.io, Node.js, MongoDB, Express.js, Axios, API
                        development, Auth, Heroku, Photoshop
                      </p>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-between items-center w-[340px] mt-5 mb-8">
                      ...
                      <a
                        href="https://github.com/spaceorb/draftbot.net"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <RegButton name={"Code"} />
